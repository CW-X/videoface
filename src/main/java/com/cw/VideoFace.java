        ...
        if(rects != null && rects.length >= 1) {
            ...
            for (int i = 0; i < rects.length; i++) {
               ...
               // Imgproc.resize(image, image, new Size(300,300));
                Imgcodecs.imwrite("E:\\" + "face.png", image);
                imageCut("E:\\" + "face.png", "E:\\" + "face2.png", rects[i].x, rects[i].y, rects[i].width, rects[i].height);// 进行图片裁剪
            }
            i++;
...
//        CascadeClassifier facebook=new CascadeClassifier("D:\\Sofeware\\opencv\\sources\\data\\haarcascades\\haarcascade_frontalface_alt.xml");
        ...
        for (Rect rect : face.toArray()) {
            ...
            imageCut(imgPath, "E:\\" + "face2.png", rect.x, rect.y, rect.width, rect.height);// 进行图片裁剪
            i++;
        }
        // 6 展示图片
